...
class CloudPointGridCutting:
    def __init__(self, x_num : int, y_num : int, point_cloud: o3d.geometry.PointCloud, output_path : string = None, output_file_type : string = ".ply", cut_type :string = 'block_num'):
        """
